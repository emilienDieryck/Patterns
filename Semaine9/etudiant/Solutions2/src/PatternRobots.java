public class PatternRobots {
	...
	public static void main(String[] args) {
		...
		FlyweightPrototype prototype = new FlyweightPrototype();
		Robot robot3 = new RobotBuilder.Builder().setCanon(10).setSchield(10).setFreq(10).setLife(10).setName("Tank").build();
		Robot robot4 = new RobotBuilder.Builder().setCanon(10).setSchield(10).setFreq(10).setLife(10).setName("GrosseBerta").build();
		prototype.put("Tank", robot3);
		prototype.put("GrosseBerta", robot4);

		Robot robot5 = prototype.createRobot("Tank");
		Robot robot6 = prototype.createRobot("GrosseBerta");
